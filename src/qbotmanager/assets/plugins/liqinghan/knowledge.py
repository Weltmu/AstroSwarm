...
FAQ = [
    ...
    },
    {
        ...
        "text": "分两个版本：免费版（QQ 官方通道基础功能 + 基础 AI 聊天）；付费版（微信 iLink 通道 + AI 大脑完整能力：记忆/人设/主动聊天/多平台 + 优先支持 + 持续更新）。进阶能力包为买断制，付一次永久可用。具体价格和购买方式见控制台「插件管理」或官网/客服报价。",
    },
    {
    ...
    },
    {
        ...
        "text": "采用邮箱账号授权：在官网注册/登录邮箱后，程序内登录同一账号即可绑定本机，不需要激活码。免费版仅支持 QQ 机器人；开通会员档解锁微信通道，进阶能力包是买断制（付一次永久可用，不按月扣费）。具体价格见控制台「插件管理」里的插件详情，或以官网/客服报价为准。换电脑用同一邮箱重新登录即可。",
    },
    {
