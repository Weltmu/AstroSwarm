...
FAQ = [
    ...
    },
    {
        ...
        "text": "客户端本身和插件全部开源免费：能力包（记忆、群管理、主动聊天、天气、定时提醒等）在控制台「插件管理」或官网插件市场直接装，源码在 GitHub（Weltmu/AstroSwarm）。只有微信 iLink 通道属于会员档功能。",
    },
    {
    ...
    },
    {
        ...
        "text": "采用邮箱账号授权：在官网注册/登录邮箱后，程序内登录同一账号即可绑定本机，不需要激活码。插件已全部免费（源码开源），只有微信通道需要会员档。换电脑用同一邮箱重新登录即可。",
    },
    {
